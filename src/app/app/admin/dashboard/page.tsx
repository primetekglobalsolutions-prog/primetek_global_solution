...
export default async function AdminAppDashboard() {
  ...
  const quickActions = [
    { href: '/app/admin/inquiries', label: 'View Inquiries', icon: MessageSquare, desc: 'Review new leads' },
    { href: '/app/admin/employees', label: 'Manage Staff', icon: Users, desc: 'Employee directory' },
    { href: '/app/admin/attendance', label: 'Attendance', icon: Clock, desc: 'View reports' },
    { href: '/app/admin/settings', label: 'Settings', icon: Settings, desc: 'System config' },
  ];
    ...
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-2xl border border-border/50 shadow-sm overflow-hidden">
        <div className="px-4 py-3 border-b border-border/50 flex items-center justify-between">
          ...
          <Link href="/app/admin/inquiries" className="text-[10px] font-bold text-primary-500 uppercase tracking-widest">
            All
          </Link>
        </div>
