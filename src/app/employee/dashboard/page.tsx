      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="bg-white rounded-2xl border border-border/50 shadow-sm overflow-hidden">
          <div className="px-4 py-3 border-b border-border/50 flex items-center justify-between">
            ...
            {empRecords.length > 5 && (
              <Link href="/employee/attendance" className="text-[10px] font-bold text-primary-500 uppercase tracking-widest">
                All
              </Link>
            )}
          </div>
        ...
        <div className="bg-white rounded-2xl border border-border/50 shadow-sm overflow-hidden">
          <div className="px-4 py-3 border-b border-border/50 flex items-center justify-between">
            ...
            <Link href="/employee/assignments" className="text-[10px] font-bold text-primary-500 uppercase tracking-widest">
              View All
            </Link>
          </div>
